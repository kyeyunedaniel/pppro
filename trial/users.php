...
<div id="myNav1" class="overlay">
  ...
  <div class="overlay-content">
   <form style="background-color:#FFFFFF; padding: 10px;" action="users.php" method="POST">
        <br><br>
        <div class="form-row">
...
<div class = "bt1">
  <br>
  <br>
  <button  type="button" class="btn btn-primary btn-lg" onclick="openNav()">ADD USER</button>
  <br><br>

  <form action="users.php" method="POST"></form>
  Number of Records to Add:
  <div>
  <input type = "number" name = "batchNo2" > 
  <br>
  <input type ="submit" name ="submirad2">
</div>
